...
import { pickRoot } from '../lib/fsStore';
...
export default function App() {
    ...
    return (<div class="container py-4">
      <div class="d-flex flex-wrap gap-2 mb-3 align-items-center">
        ...
        {root && scouter && view !== 'home' && (<button class="btn btn-light" onClick={() => setView('home')}>Home</button>)}
      </div>
      {!root && <p class="text-muted">Please pick a data folder to get started.</p>}
      {root && scouter && view === 'home' && <Home navigate={(v) => setView(v)}/>}
